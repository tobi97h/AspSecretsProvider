...
public static class WebApplicationBuilderExtension
{
    ...
    public static void AddSecretsProvider(this WebApplicationBuilder builder, string defaultSection)
    {
    ...
    public static void AddDevSecretsProvider(this IServiceCollection serviceCollection, string defaultSection)
    {
        serviceCollection
    ...
    public static void AddEnvSecretsProvider(this IServiceCollection serviceCollection, string defaultSection)
    {
        serviceCollection
